(function($){  
	...
	$('div.shiti').each(function(i,v){
		...
		// console.log(i,istrue,$(this).find('.youanswerdan'),$(this).find('.youanswerdduo'))
		if(istrue){
...
function submitshijuan(clickval){
	...
	// console.log('yuansheng',tianswer);
	// tianswer = tianswer.replace(/&/g,'');
	tianswer = tianswer.replace(/,/g,' ');
	// tianswer = tianswer.replace(/m/g,',');
	// console.log("tianswer",tianswer);
	// 数组去空
	var arrtian = [];
